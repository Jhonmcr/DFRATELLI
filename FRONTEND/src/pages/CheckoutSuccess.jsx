...
const CheckoutSuccess = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1a0f05] flex items-center justify-center pt-20 px-4">
      
      {/* ─── CAJA DIÁLOGO ─── */}
      <div className="bg-[#2a1b0a] border border-green-500/30 p-10 md:p-14 rounded-3xl text-center max-w-xl w-full shadow-[0_0_50px_rgba(34,197,94,0.1)] relative overflow-hidden">
        ...
        <h2 className="text-4xl font-extrabold text-white mb-4">¡Compra Exitosa!</h2>
        ...
        <div className="mb-8">
            ...
            {orderData && (
                <div className="mt-4 p-4 bg-[#1a0f05] border border-[#5C3D11]/50 rounded-xl text-sm">
                    <p className="text-gray-400">Número de Orden de Seguimiento:</p>
                    <p className="text-white font-mono font-bold text-lg">#{String(orderData.id).padStart(6, '0')}</p>
                </div>
            )}
